...
function HeroSection() {
  ...
  return (
    <section className="relative min-h-[90vh] flex flex-col justify-center py-20 px-8 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          AI-Driven Soldier Insight
          <br />
          <span className="text-gradient">at the Point of Need</span>
        </motion.h1>
        ...
        >
          ...
          and the world's most capable Training Edge Device (TED). Our integrated
          ecosystem supports next-generation Live Training and Test & Evaluation.
        </motion.p>
        ...
        >
          <Button to="/ted" variant="primary" size="lg" icon={<ArrowRight size={18} />}>
            Explore TED
          </Button>
      ...
      <motion.div
        ...
        initial="initial"
        animate="animate"
        className="relative z-10 flex justify-center gap-12 md:gap-20 mt-20 flex-wrap"
      >
        {stats.map((stat, i) => (
          <motion.div
            key={i}
          ...
          >
            <span className="block text-4xl md:text-5xl font-extrabold text-primary-500 font-mono">
              {stat.number}
            </span>
            <span className="text-sm text-dark-500 uppercase tracking-wider">
              {stat.label}
            </span>
          </motion.div>
        ))}
