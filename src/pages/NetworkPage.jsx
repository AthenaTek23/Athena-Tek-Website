...
/* Banner image - import */
import bannerImg from '../assets/5G_Military_Banner_Small-Img_2.png';
...
export default function NetworkPage() {
  return (
	...
	<div
      ...
      {/* Embedded Network Monitor Application */}
      <section className="w-full bg-dark-950">
        ...
        <iframe
          src="/monitors/network/index.html"
          title="Network Monitor Application"
          style={{
            width: '100%',
            height: '85vh',
            border: 'none',
