...
function LeadershipSection() {
  ...
  return (
    <section className="section-padding container-main">
      ...
      />
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 content-medium">
        {leadership.map((leader, i) => (
          ...
          >
            <Card size="lg" className="text-center">
              ...
              <p className="text-sm text-dark-300 leading-relaxed">{leader.desc}</p>
            </Card>
          </motion.div>
        ))}
      </div>
